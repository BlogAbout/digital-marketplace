...
class UpdateCategoryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'category_id' => [
                ...
                Rule::notIn([$categoryId]), // Нельзя указать себя как родителя
            ],
            'name' => [
                'sometimes',
                'string',
            ...
            'slug' => [
                ...
                'string',
                'max:255',
                Rule::unique('shop_category', 'slug')->ignore($categoryId),
            ],
            'slogan' => [
                'nullable',
                'string',
    ...
    public function messages(): array
    {
        return [
            ...
            'category_id.not_in' => 'Нельзя указать себя как родительскую категорию',
